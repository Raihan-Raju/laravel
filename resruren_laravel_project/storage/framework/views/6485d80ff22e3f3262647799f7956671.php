<div class="sidebar sidebar-style-2" data-background-color="dark">
        ...
        <div class="sidebar-wrapper scrollbar scrollbar-inner">
          <div class="sidebar-content">
            <ul class="nav nav-secondary">
              <li class="nav-item">
                <a href="<?php echo e(url('/dashbord')); ?>"> <i class="fas fa-home"></i> <p>Dashboard</p></a>
              ...
              <li class="nav-item">
                ...
                <div class="collapse" id="tables">
                  <ul class="nav nav-collapse">
                    ...
                    <li>
                      <a href="<?php echo e(url('/customermanage')); ?>">
              ...
              <li class="nav-item">
                ...
                <div class="collapse" id="maps">
                  <ul class="nav nav-collapse">
                    <li>
                      <a href="<?php echo e(url('/addcost')); ?>">
                        <span class="sub-item">Cost Add</span>
                      </a>
                    </li>
                    <li>
                      <a href="<?php echo e(url('/managecost')); ?>">
      ...
      </div><?php /**PATH D:\xampp\htdocs\laravel\resruren_laravel_project\resources\views/admin_layout/sideadmin.blade.php ENDPATH**/ ?>